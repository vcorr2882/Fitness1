...
public class ShouldersMain extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.shoulders_main);

        //Code for intent on button1 and linear layout1
        imageButton1 = findViewById(R.id.shouldersmainbutton1);
        ...
        imageButton2 = findViewById(R.id.shouldersmainbutton2);
        ...
        imageButton3 = findViewById(R.id.shouldersmainbutton3);
