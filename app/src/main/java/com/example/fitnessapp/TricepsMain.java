...
public class TricepsMain extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.triceps_main);

        //Code for intent on button1 and linear layout1
        imageButton1 = findViewById(R.id.tricepsmainbutton1);
        ...
        imageButton2 = findViewById(R.id.tricepsmainbutton2);
        ...
        imageButton3 = findViewById(R.id.tricepsmainbutton3);
